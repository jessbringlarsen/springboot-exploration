...
class WithdrawMoneyUseCaseInputValidationTest extends ConstraintValidationTest {
    ...
    @BeforeEach
    void setup() {
        useCase = new WithdrawMoneyUseCase(validator, transactionRepository, accountRepository);
    }
